...
from .configuration_cadence import CadenceConfig
from .modeling_cadence import CadenceModel, CustomCausalLMOutput
...
class EnergyTransformer(CadenceModel):
    """
    The main continuous autoregressive model for Cadence AI.
    ...
    def __init__(self, config):
        ...
        # Freeze the autoencoder weights during training
